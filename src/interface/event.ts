enum IEVENT_NAME {
  ...
  "EVENT_TRANSFER_IN" = "EVENT_TRANSFER_IN",
  "EVENT_TRANSFER_IN_CONFIRM" = "EVENT_TRANSFER_IN_CONFIRM",
  "EVENT_TRANSFER_IN_REFUND" = "EVENT_TRANSFER_IN_REFUND",
  "EVENT_INIT_SWAP" = "EVENT_INIT_SWAP",
  "EVENT_CONFIRM_SWAP" = "EVENT_CONFIRM_SWAP",
  "EVENT_REFUND_SWAP" = "EVENT_REFUND_SWAP",
}
...
interface IEVENT_TRANSFER_IN {

}
interface IEVENT_TRANSFER_IN_CONFIRM {

}
interface IEVENT_INIT_SWAP {

}
interface IEVENT_REFUND_SWAP {

}
interface IEVENT_CONFIRM_SWAP {
